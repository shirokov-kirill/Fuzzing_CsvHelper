...
public class UInt64Converter : DefaultTypeConverter
{
	...
	{
		FuzzingLogsCollector.Log("UInt64Converter", "ConvertFromString", 25);
		...
		{
			FuzzingLogsCollector.Log("UInt64Converter", "ConvertFromString", 30);
			return ul;
		}

		FuzzingLogsCollector.Log("UInt64Converter", "ConvertFromString", 34);
