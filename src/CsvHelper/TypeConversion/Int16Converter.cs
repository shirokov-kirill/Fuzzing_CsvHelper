...
public class Int16Converter : DefaultTypeConverter
{
	...
	{
		FuzzingLogsCollector.Log("Int16Converter", "ConvertFromString", 25);
		...
		{
			FuzzingLogsCollector.Log("Int16Converter", "ConvertFromString", 30);
			return s;
		}

		FuzzingLogsCollector.Log("Int16Converter", "ConvertFromString", 34);
